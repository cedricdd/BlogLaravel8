...
<head>
    ...
    <meta name="description" content="{{ $post?->meta_description ?? config('app.description') }}">
    <meta name="author" content="{{ $post?->user?->name ?? config('app.author') }}">
...
<body id="top">
    ...
    <!-- header
    ================================================== -->
    <header class="s-header @if(!currentRoute('home')) s-header--opaque @endif">
